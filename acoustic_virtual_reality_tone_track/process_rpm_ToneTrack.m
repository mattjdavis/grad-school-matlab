function [ behavior] = process_rpm_lick( rpmPath, nF)
%UNTITLED4 Summary of this function goes here
%   Detailed explanation goes here

% trialDuration, seconds 1800 seconds in 30 mins

% read variables, from arduino. rpm_lick_7 files
%1=timestamp
%2=rpm
%3=transitionCounter
%4=rewardCounter
%5=manualRewardCounter
%6=lick
%7=position
%8=zone
%ard_timestamp,lick_voltage,beep_on
...
%     end
    ...
    position_in_lap=read(:,7);
    zone=read(:,8);
    SQUARES_PER_LAP=max(position_in_lap);
    %%%%%%%%%%%%%%%%%%
    
    position=read(:,3);
    position_ds=read_ds(:,3);
    ...
    behavior=v2struct(run,position,position_ds,lap, lap_times,position_in_lap,lap_num,reward, reward_times,...
        reward_num,mreward_times, mreward, mreward_num,total_reward,total_reward,...
        all_reward_times,lick,lick_times,lick_num,zone,RAW_FILE,DS_FILE);
